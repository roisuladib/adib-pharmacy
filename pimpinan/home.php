...
<div class="row">
   ...
   <?php
      ...
      $current_year = date('Y');
      $month        = date('m');
      $transaction_months = mysqli_query($kon, "SELECT tanggaltransaksi, SUM(totalharga) AS totalharga FROM transaksi WHERE MONTH(tanggaltransaksi) = '$month' AND YEAR(tanggaltransaksi) = '$current_year'");
