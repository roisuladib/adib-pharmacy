      ...
      <div class="card shadow b-20 mb-4">
         ...
         <div class="card-body">
            <form action="" method="POST" onsubmit="return popUp(850, 500);">
               ...
               <button type="submit" name="submit" id="submit" class="btn mt-4 mb-3 btn-info box-shadow-none btn-block b-20">Cetak</button>
            </form>
         </div>
      </div>
   </div>
...
<script>
   function popUp(w, h){
      ...
      const newWin = window.open ('cetaklaporan.php?awal=' + awal + '&akhir=' + akhir, 'Laporan', 'toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=yes, resizable=no, copyhistory=no, width='+w+', height='+h+', top='+top+', left='+left);
   }
</script>